...
var $author$project$PhotoGroove$viewLarge = function (model) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
...
var $author$project$PhotoGroove$isChecked = F2(
	function (size, model) {
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$PhotoGroove$isChecked, size, model))
						]),
					_List_Nil),
					$elm$html$Html$text(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					model.photos)),
				$author$project$PhotoGroove$viewLarge(model)
			]));
};
