...
var $author$project$Types$GotPosts = function (a) {
	return {$: 'GotPosts', a: a};
};
...
var $author$project$Types$initialCmd = $elm$http$Http$get(
	{
		expect: A2(
			...
			$author$project$Types$GotPosts,
			$elm$json$Json$Decode$list($author$project$Types$postDecoder)),
...
var $author$project$View$viewTableBody = function (posts) {
	return A2(
		$elm$html$Html$tbody,
		_List_Nil,
		A2($elm$core$List$map, $author$project$View$viewTableData, posts));
};
...
var $author$project$View$viewTable = function (posts) {
	return A2(
		$elm$html$Html$table,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$View$viewTableBody(posts)
			]));
};
var $author$project$View$viewLoaded = function (posts) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$View$viewTable(posts)
			]));
};
...
var $author$project$View$viewTableDataLoading = A2(
	$elm$html$Html$tr,
	_List_Nil,
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('skeleton-text')
						]),
					_List_Nil)
				])),
			A2(
...
var $author$project$View$viewTableBodyLoading = A2(
	$elm$html$Html$tbody,
	_List_Nil,
	A2($elm$core$List$repeat, 3, $author$project$View$viewTableDataLoading));
var $author$project$View$viewTableLoading = A2(
	$elm$html$Html$table,
	_List_Nil,
	_List_fromArray(
		[$author$project$View$viewTableHeader, $author$project$View$viewTableBodyLoading]));
var $author$project$View$viewLoading = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[$author$project$View$viewTableLoading]));
